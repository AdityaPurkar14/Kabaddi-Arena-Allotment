...
public class CheckArenas extends JFrame implements Runnable{
    ...
    public void run()
    {
        String[] text=new String[]{"Kabaddi Complex","Hukuku Ground","O2","Dynamic Sports Ground","Patliputra Ground","Le Pangaaa","Kabaddi ka Maidan","Hydra Sports Complex"};
        try{
            for(int i=0;i<=7;i++){
    ...
    CheckArenas()
    {
       ...
       for(int i=0;i<=7;i++)
       {
       image[i]=new ImageIcon(ClassLoader.getSystemResource("images/ss"+(i+1)+".jpeg"));
