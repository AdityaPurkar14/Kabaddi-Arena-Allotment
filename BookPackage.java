...
public class BookPackage extends JFrame implements ActionListener{
    ...
    lblplayers.setBounds(40, 150, 150, 25);
    add(lblplayers);
    
    tplayers=new JTextField("1");
    tplayers.setBounds(250, 150, 200, 20);
    add(tplayers);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==checkprice){
            ...
            try{
                Conn c=new Conn();
                c.s.executeUpdate("insert into bookpackage values('"+labelusername.getText()+"','"+cpackage.getSelectedItem()+"','"+tplayers.getText()+"','"+labelid.getText()+"','"+labelnumber.getText()+"','"+labelphone.getText()+"','"+labelprice.getText()+"')");
